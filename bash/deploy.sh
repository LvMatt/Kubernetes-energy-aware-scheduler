if [ "$1" == "delete" ]; then
	...
	kubectl delete -f ./RL-service/deploy/rl-scheduler-deployment.yaml -n kube-system
else 
	...
	kubectl apply -f ./RL-service/deploy/rl-scheduler-deployment.yaml -n kube-system
fi